...
7. Confirmar o processo de Authenticode com o certificado Karvalho.
...
ou certificados reais continuam condicionados à disponibilidade externa.
...
5. Validar Authenticode e publicador antes da execução.
6. Reverificar todo o artefato imediatamente antes de abrir.
7. Remover rollback por cópia de `RFNextInfo.exe`.
8. Implementar rollback por instalador anterior assinado.
...
- rollback explícito ignora somente sequence, mantendo todas as assinaturas;
...
6. Preparar resposta a revogação de certificado ou comprometimento de chave.
...
- G2 — fluxo pode ser preparado; certificado real permanece indisponível ou
  não confirmado.
...
- Custo real: `unknown`; nenhum certificado, serviço ou infraestrutura foi
